...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save Token and Profile Image URL in LocalStorage
      localStorage.setItem("token", res.data.token);

      if (res.data.user && res.data.user.profileImage) {
        localStorage.setItem("userImg", res.data.user.profileImage);
      } else {
        localStorage.removeItem("userImg"); // Clear if no image exists
      }
